...
class ChatInput extends Component<Props, State> {
    ...
    constructor(props: Props) {
        ...
        this._onSubmitAttachment = this._onSubmitAttachment.bind(this);
                        ...
                        <div id = 'smileysarea'>
                            <div id = 'smileys'>
                                <div
                                    ...
                                    className = {`smiley-button${this.state.showSmileysPanel ? ' active' : ''}`}
                            ...
                            <OutsideClickHandler onOutsideClick={ () => this.setState({showSmileysPanel: false}) }>
                                <Picker style={{width: '100%'}} onSelect={this._selectEmoji} set='facebook'/>
                             </OutsideClickHandler>
                    ...
                    {/*
                        <div className = 'send-button-container'>
                            <div
                                aria-label = { this.props.t('chat.sendButton') }
                                className = 'send-button'
                                onClick = { this._onSubmitAttachment }
                                onKeyPress = { this._onSubmitMessageKeyPress }
                                role = 'button'
                                tabIndex = { this.state.message.trim() ? 0 : -1 } >
     ...
     */
    _onSubmitAttachment() {
        parent.postMessage("jitsi_attach", "*")
        // const trimmed = this.state.message.trim();
     ...
     */
    _selectEmoji(event) {
        // this.state.message += event.native;
        this.setState({ message: this.state.message + event.native});
